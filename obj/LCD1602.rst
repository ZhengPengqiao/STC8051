      ...
      000000                        277 	.ds 8
                                    ...
                                    280 ;--------------------------------------------------------
                                    281 	.area DSEG    (DATA)
      00003F                        282 _LcdSetCursor_PARM_2:
      00003F                        283 	.ds 1
      000040                        284 _LcdAreaClear_PARM_2:
      000040                        285 	.ds 1
      000041                        286 _LcdAreaClear_PARM_3:
      000041                        287 	.ds 1
      000042                        288 _LcdShowString_PARM_2:
      000042                        289 	.ds 1
      000043                        290 _LcdShowString_PARM_3:
      000043                        291 	.ds 3
                                    292 ;--------------------------------------------------------
      ...
      00082E 22               [24]  386 	ret
                                    ...
                                    395 ;	-----------------------------------------
      00082F                        396 _LcdWriteCmd:
      00082F AF 82            [24]  397 	mov	r7,dpl
                                    398 ;	LCD1602/LCD1602.c:31: LcdWaitReady();
      000831 C0 07            [24]  399 	push	ar7
      000833 12 08 1D         [24]  400 	lcall	_LcdWaitReady
      000836 D0 07            [24]  401 	pop	ar7
                                    402 ;	LCD1602/LCD1602.c:32: LCD1602_RS = 0;   //命令
      000838 C2 90            [12]  403 	clr	_P1_0
                                    404 ;	LCD1602/LCD1602.c:33: LCD1602_RW = 0;   //写
      00083A C2 91            [12]  405 	clr	_P1_1
                                    406 ;	LCD1602/LCD1602.c:34: LCD1602_DB = cmd;
      00083C 8F 80            [24]  407 	mov	_P0,r7
                                    408 ;	LCD1602/LCD1602.c:35: LCD1602_E = 1;    //脉冲
      00083E D2 95            [12]  409 	setb	_P1_5
                                    410 ;	LCD1602/LCD1602.c:36: LCD1602_E = 0;
      000840 C2 95            [12]  411 	clr	_P1_5
      000842 22               [24]  412 	ret
                                    413 ;------------------------------------------------------------
                                    ...
                                    421 ;	-----------------------------------------
      000843                        422 _LcdWriteData:
      000843 AF 82            [24]  423 	mov	r7,dpl
                                    424 ;	LCD1602/LCD1602.c:47: LcdWaitReady();
      000845 C0 07            [24]  425 	push	ar7
      000847 12 08 1D         [24]  426 	lcall	_LcdWaitReady
      00084A D0 07            [24]  427 	pop	ar7
                                    428 ;	LCD1602/LCD1602.c:48: LCD1602_RS = 1;   //数据
      00084C D2 90            [12]  429 	setb	_P1_0
                                    430 ;	LCD1602/LCD1602.c:49: LCD1602_RW = 0;   //写
      00084E C2 91            [12]  431 	clr	_P1_1
                                    432 ;	LCD1602/LCD1602.c:50: LCD1602_DB = data;
      000850 8F 80            [24]  433 	mov	_P0,r7
                                    434 ;	LCD1602/LCD1602.c:51: LCD1602_E = 1;    //脉冲
      000852 D2 95            [12]  435 	setb	_P1_5
                                    436 ;	LCD1602/LCD1602.c:52: LCD1602_E = 0;
      000854 C2 95            [12]  437 	clr	_P1_5
      000856 22               [24]  438 	ret
                                    439 ;------------------------------------------------------------
                                    ...
                                    449 ;	-----------------------------------------
      000857                        450 _LcdSetCursor:
      000857 AF 82            [24]  451 	mov	r7,dpl
                                    452 ;	LCD1602/LCD1602.c:65: if( y == 0)  //根据输入计算地址
      000859 E5 3F            [12]  453 	mov	a,_LcdSetCursor_PARM_2
      00085B 70 04            [24]  454 	jnz	00102$
                                    455 ;	LCD1602/LCD1602.c:67: addr = 0+x; //第一行地址从0x00开始
      00085D 8F 06            [24]  456 	mov	ar6,r7
      00085F 80 04            [24]  457 	sjmp	00103$
      000861                        458 00102$:
                                    459 ;	LCD1602/LCD1602.c:71: addr = 0x40 + x;  //第二行地址从0x40开始
      000861 74 40            [12]  460 	mov	a,#0x40
      000863 2F               [12]  461 	add	a,r7
      000864 FE               [12]  462 	mov	r6,a
      000865                        463 00103$:
                                    464 ;	LCD1602/LCD1602.c:73: LcdWriteCmd(addr | 0x80); //设置RAM地址
      000865 74 80            [12]  465 	mov	a,#0x80
      000867 4E               [12]  466 	orl	a,r6
      000868 F5 82            [12]  467 	mov	dpl,a
      00086A 02 08 2F         [24]  468 	ljmp	_LcdWriteCmd
                                    469 ;------------------------------------------------------------
      ...
      00086D 75 82 38         [24]  478 	mov	dpl,#0x38
      000870 12 08 2F         [24]  479 	lcall	_LcdWriteCmd
                                    480 ;	LCD1602/LCD1602.c:85: LcdWriteCmd(0x0C);  //显示器开,光标关闭
      000873 75 82 0C         [24]  481 	mov	dpl,#0x0C
      000876 12 08 2F         [24]  482 	lcall	_LcdWriteCmd
                                    483 ;	LCD1602/LCD1602.c:86: LcdWriteCmd(0x06);  //文字不动,地址自动加一
      000879 75 82 06         [24]  484 	mov	dpl,#0x06
      00087C 12 08 2F         [24]  485 	lcall	_LcdWriteCmd
                                    486 ;	LCD1602/LCD1602.c:87: LcdWriteCmd(0x01);  //清屏
      00087F 75 82 01         [24]  487 	mov	dpl,#0x01
      000882 02 08 2F         [24]  488 	ljmp	_LcdWriteCmd
                                    489 ;------------------------------------------------------------
                                    ...
                                    495 ;	-----------------------------------------
      000885                        496 _LcdFullClear:
                                    497 ;	LCD1602/LCD1602.c:98: LcdWriteCmd(0x01);
      000885 75 82 01         [24]  498 	mov	dpl,#0x01
      000888 02 08 2F         [24]  499 	ljmp	_LcdWriteCmd
                                    500 ;------------------------------------------------------------
                                    ...
                                    510 ;	-----------------------------------------
      00088B                        511 _LcdAreaClear:
                                    512 ;	LCD1602/LCD1602.c:109: LcdSetCursor(x,y); //将光标移动到制定位置
      00088B 85 40 3F         [24]  513 	mov	_LcdSetCursor_PARM_2,_LcdAreaClear_PARM_2
      00088E 12 08 57         [24]  514 	lcall	_LcdSetCursor
                                    515 ;	LCD1602/LCD1602.c:110: while(len--)
      000891 AF 41            [24]  516 	mov	r7,_LcdAreaClear_PARM_3
      000893                        517 00101$:
      000893 8F 06            [24]  518 	mov	ar6,r7
      000895 1F               [12]  519 	dec	r7
      000896 EE               [12]  520 	mov	a,r6
      000897 60 0C            [24]  521 	jz	00104$
                                    522 ;	LCD1602/LCD1602.c:112: LcdWriteData(' ');
      000899 75 82 20         [24]  523 	mov	dpl,#0x20
      00089C C0 07            [24]  524 	push	ar7
      00089E 12 08 43         [24]  525 	lcall	_LcdWriteData
      0008A1 D0 07            [24]  526 	pop	ar7
      0008A3 80 EE            [24]  527 	sjmp	00101$
      0008A5                        528 00104$:
      0008A5 22               [24]  529 	ret
                                    530 ;------------------------------------------------------------
                                    ...
                                    540 ;	-----------------------------------------
      0008A6                        541 _LcdShowString:
                                    542 ;	LCD1602/LCD1602.c:125: LcdSetCursor(x,y); //设置起始地址
      0008A6 85 42 3F         [24]  543 	mov	_LcdSetCursor_PARM_2,_LcdShowString_PARM_2
      0008A9 12 08 57         [24]  544 	lcall	_LcdSetCursor
                                    545 ;	LCD1602/LCD1602.c:126: while(*str != '\0')  //连续写入数据,直到检测到结束符
      0008AC AD 43            [24]  546 	mov	r5,_LcdShowString_PARM_3
      0008AE AE 44            [24]  547 	mov	r6,(_LcdShowString_PARM_3 + 1)
      0008B0 AF 45            [24]  548 	mov	r7,(_LcdShowString_PARM_3 + 2)
      0008B2                        549 00101$:
      0008B2 8D 82            [24]  550 	mov	dpl,r5
      0008B4 8E 83            [24]  551 	mov	dph,r6
      0008B6 8F F0            [24]  552 	mov	b,r7
      0008B8 12 0D 67         [24]  553 	lcall	__gptrget
      0008BB FC               [12]  554 	mov	r4,a
      0008BC 60 18            [24]  555 	jz	00104$
                                    556 ;	LCD1602/LCD1602.c:128: LcdWriteData(*str++);  //先发送数据,然后str+1
      0008BE 8C 82            [24]  557 	mov	dpl,r4
      0008C0 0D               [12]  558 	inc	r5
      0008C1 BD 00 01         [24]  559 	cjne	r5,#0x00,00114$
      0008C4 0E               [12]  560 	inc	r6
      0008C5                        561 00114$:
      0008C5 C0 07            [24]  562 	push	ar7
      0008C7 C0 06            [24]  563 	push	ar6
      0008C9 C0 05            [24]  564 	push	ar5
      0008CB 12 08 43         [24]  565 	lcall	_LcdWriteData
      0008CE D0 05            [24]  566 	pop	ar5
      0008D0 D0 06            [24]  567 	pop	ar6
      0008D2 D0 07            [24]  568 	pop	ar7
      0008D4 80 DC            [24]  569 	sjmp	00101$
      0008D6                        570 00104$:
      0008D6 22               [24]  571 	ret
                                    572 	.area CSEG    (CODE)
                                    573 	.area CONST   (CODE)
                                    574 	.area XINIT   (CODE)
